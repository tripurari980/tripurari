...
(function($) {
    $.fn.amazingslider = function(options) {
        ...
        var TYPE_IMAGE = 1,
            ...
            TYPE_VIDEO_VIMEO = 10;
        var AmazingSlider = function(container, options, textoptions,
            id) {
        ...
        AmazingSlider.prototype = {
            ...
            createMarkup: function() {
                this.$wrapper = jQuery("" + "<div class='amazingslider-wrapper-" + this.id + "'>" + "<div class='amazingslider-background-image-" + this.id + "'></div>" + "<div class='amazingslider-slider-" + this.id + "'>" + "<div class='amazingslider-bottom-shadow-" + this.id + "'></div>" + "<div class='amazingslider-box-" + this.id + "'>" + "<div class='amazingslider-swipe-box-" + this.id + "'>" + "<div class='amazingslider-space-" +
                    this.id + "'></div>" + "<div class='amazingslider-img-box-" + this.id + "'></div>" + "<div class='amazingslider-lightbox-play-" + this.id + "'></div>" + "</div>" + "</div>" + "<div class='amazingslider-text-box-" + this.id + "'></div>" + "<div class='amazingslider-play-" + this.id + "'></div>" + "<div class='amazingslider-video-wrapper-" + this.id + "'></div>" + "<div class='amazingslider-ribbon-" + this.id + "'></div>" + "<div class='amazingslider-arrow-left-" + this.id + "'></div>" + "<div class='amazingslider-arrow-right-" + this.id + "'></div>" +
                        ...
                        if (!instance.elemArray[cur][ELEM_TITLE] && !instance.elemArray[cur][ELEM_DESCRIPTION]) $textWrapper.fadeOut();
                            ...
                            switch (pos) {
                                ...
                                case "bottomleft":
                                    ...
                                    $textWrapper.css({
                                        margin: instance.textoptions.textpositionmarginbottom + "px " + instance.textoptions.textpositionmarginleft +
                                            "px"
                                    });
                                    break;
                                case "bottomright":
            ...
            resizeSlider: function() {
                ...
                if (this.options.navthumbnavigationstyle != "auto") {
                    ...
                    if (this.options.navmultirows) {
                        ...
                        var l = 0;
                        if (this.options.navdirection == "vertical") l = isNaN(parseInt($bulletWrapper.css("margin-top"))) ? 0 : parseInt($bulletWrapper.css("margin-top"));
                        else l = isNaN(parseInt($bulletWrapper.css("margin-left"))) ? 0 : parseInt($bulletWrapper.css("margin-left"));
            ...
            createStyle: function() {
                ...
                if (this.options.border > 0) styleCss += "margin-left:-" + this.options.border + "px;border-width:" + this.options.border + "px;border-style:solid;border-color:" + this.options.bordercolor +
                    ";";
                if (this.options.borderradius > 0) styleCss += "border-radius:" + this.options.borderradius + "px;-moz-border-radius:" + this.options.borderradius + "px;-webkit-border-radius:" + this.options.borderradius + "px;";
                ...
                styleCss += ".amazingslider-img-box-" +
                    this.id + " {display:block;position:absolute;left:0px;top:0px;width:100%;height:100%;}";
                ...
                styleCss += ".amazingslider-video-wrapper-" +
                    this.id + " {display:none;position:absolute;left:0px;top:0px;background-color:#000;text-align:center;}";
                styleCss += ".amazingslider-error-" + this.id + " {display:block;position:relative;margin:0 auto;width:80%;top:50%;color:#fff;font:16px Arial,Tahoma,Helvetica,sans-serif;}";
                if (this.options.showribbon) {
                    styleCss += ".amazingslider-ribbon-" + this.id + " {display:block;position:absolute;";
                    switch (this.options.ribbonposition) {
                        case "topleft":
                            styleCss += "left:" + this.options.ribbonimagex + "px;top:" + this.options.ribbonimagey +
                                "px;";
                            break;
                        case "topright":
            ...
            createBottomShadow: function() {
                ...
                var $shadow =
                    $(".amazingslider-bottom-shadow-" + this.id, this.container);
            ...
            createNav: function() {
                ...
                if (this.options.navstyle != "none") {
                    ...
                    if (instance.options.navthumbnavigationstyle == "auto") $nav.mousemove(function(e) {
                        ...
                        if (instance.options.navdirection == "horizontal")
                            if (instance.options.navmultirows) {
                                ...
                                m = Math.floor(($nav.width() - n * instance.options.navwidth -
                                    (n - 1) * instance.options.navspacing) / 2);
                                $navContainer.css({
                                    width: "100%",
                                    "margin-left": m + "px"
                                })
                        ...
                        $carLeftArrow.css({
                            ...
                            background: "url('" + instance.options.skinsfolder + instance.options.navthumbnavigationarrowimage +
                                "') no-repeat left top"
                        });
                        $carRightArrow.css({
                            overflow: "hidden",
                        ...
                        var p = instance.options.navdirection == "vertical" ? instance.options.navwidth / 2 - instance.options.navthumbnavigationarrowimagewidth / 2 : instance.options.navheight /
                            2 - instance.options.navthumbnavigationarrowimageheight / 2;
                        ...
                        if (instance.options.navdirection == "vertical" && $bulletWrapper.height() > $navContainer.height() || instance.options.navdirection == "horizontal" && $bulletWrapper.width() >
                            $navContainer.width()) {
                            $carLeftArrow.css({
                                display: "block",
                                "background-position": "left bottom",
                    ...
                    if (this.options.navshowpreview) {
                        var $preview = $("<div class='amazingslider-nav-preview-" + this.id + "' style='display:none;position:absolute;width:" + this.options.navpreviewwidth + "px;height:" + this.options.navpreviewheight + "px;background-color:" +
                            this.options.navpreviewbordercolor + ";padding:" + instance.options.navpreviewborder + "px;'></div>");
                        ...
                        var $previewImages =
                            $("<div class='amazingslider-nav-preview-images-" + this.id + "' style='display:block;position:relative;width:100%;height:100%;overflow:hidden;' />");
            ...
            createNavBullet: function(index) {
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    if (this.options.navbuttonshowbgimage && this.options.navbuttonbgimage) $bullet.css({
                        background: "url('" + this.options.skinsfolder + this.options.navbuttonbgimage +
                    ...
                    $.fn["bulletHighlight" + this.id] = $.fn["bulletSelected" + this.id] = function() {
                        ...
                        if (instance.options.navbuttonshowbgimage &&
                            instance.options.navbuttonbgimage) $(this).css({
                    ...
                    $(imgLoader).load(function() {
                        if (instance.options.navthumbstyle != "textonly") {
                            ...
                            if (this.width / this.height <=
                                instance.options.navimagewidth / instance.options.navimageheight) style = "max-width:none !important;width:100%;height:auto;margin-top:-" + Math.floor(this.height / this.width * instance.options.navimagewidth / 2 - instance.options.navimageheight / 2) + "px";
                            ...
                            $bullet.append("<div class='amazingslider-bullet-image-" + instance.id + "' style='display:block;position:absolute;width:" +
                                instance.options.navimagewidth + "px;height:" + instance.options.navimageheight + "px;overflow:hidden;'><img src='" + instance.elemArray[index][ELEM_THUMBNAIL] + "' style='" + style + "' /></div>");
                        ...
                        if (instance.options.navthumbstyle != "imageonly") {
                            ...
                            if (instance.options.navthumbstyle == "imageandtitle") thumbtitle += "margin-left:0px;margin-top:" + instance.options.navimageheight +
                                "px;width:" + instance.options.navimagewidth + "px;height:" + instance.options.navthumbtitleheight + "px;";
                            ...
                            else if (instance.options.navthumbstyle == "textonly") thumbtitle += "margin-left:0px;margin-top:0px;width:" + String(instance.options.navthumbtitlewidth + instance.options.navimagewidth) +
            ...
            slideRun: function(index, playVideo) {
                ...
                this.sliderTimeout.stop();
                this.sliderTimeout.timeout = this.elemArray[this.curElem][ELEM_DURATION] >
                    0 ? this.elemArray[this.curElem][ELEM_DURATION] : this.options.slideinterval;
        ...
        this.each(function() {
            ...
            if (this.options.versionmark != "AMC" + "om") {
                this.options.showwatermark = window.location.href.indexOf(this.options.vermk) >= 0 ? false : true;
