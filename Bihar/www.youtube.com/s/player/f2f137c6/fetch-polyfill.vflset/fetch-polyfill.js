...
(function(self) {
    ...
    function readArrayBufferAsText(buf) {
        ...
        var i = 0;
        for (; i < view.length; i++) chars[i] = String.fromCharCode(view[i]);
        return chars.join("")
    }
    ...
    function Body() {
        ...
        this._initBody = function(body) {
            ...
            if (!body) this._bodyText = "";
                ...
                URLSearchParams.prototype.isPrototypeOf(body)) this._bodyText = body.toString();
            ...
            if (!this.headers.get("content-type"))
                if (typeof body === "string") this.headers.set("content-type",
    ...
    function Request(input, options) {
        ...
        if (typeof input === "string") this.url =
            input;
        else {
    ...
    self.fetch = function(input, init) {
        return new Promise(function(resolve, reject) {
            ...
            request.headers.forEach(function(value,
                name) {
